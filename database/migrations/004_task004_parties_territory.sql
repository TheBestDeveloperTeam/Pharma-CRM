...
ALTER TABLE parties ADD COLUMN IF NOT EXISTS whatsapp VARCHAR(20) NULL;
ALTER TABLE parties ADD COLUMN IF NOT EXISTS party_type VARCHAR(80) NULL;
ALTER TABLE parties ADD COLUMN IF NOT EXISTS drug_license_validity DATE NULL;
ALTER TABLE parties ADD COLUMN IF NOT EXISTS area VARCHAR(120) NULL;
ALTER TABLE parties ADD COLUMN IF NOT EXISTS remarks VARCHAR(500) NULL;
