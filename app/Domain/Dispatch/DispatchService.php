...
{
    public function __construct(private Database $db, private DispatchRepositoryInterface $dispatches, private InvoiceRepositoryInterface $invoices, private OrderRepositoryInterface $orders, private SequenceService $sequences, private FefoAllocator $fefo) {}
